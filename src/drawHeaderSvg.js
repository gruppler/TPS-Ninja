...
function drawHeaderSvg(
  ...
  if (options.player1) {
    ...
    svg.text(
      ...
      textY,
      player1,
      { fill: fill1, fontSize: fontSize, fontFamily: font, textAnchor: "start", dy: "0.35em" }
    );
  }
  // Player 1 Flat Count
  if (flats[0] !== "") {
    ...
    svg.text(
      ...
      textY,
      parts[0],
      { fill: fill1, fontSize: fontSize, fontFamily: font, textAnchor: "end", dy: "0.35em" }
    );
    if (parts[1]) {
      ...
      svg.text(
        ...
        textY,
        komiText,
        { fill: fill1, fontSize: fontSize, fontFamily: font, textAnchor: "end", dy: "0.35em", opacity: 0.5 }
      );
    }
  }
  ...
  if (options.player2) {
    ...
    svg.text(
      ...
      textY,
      player2,
      { fill: fill2, fontSize: fontSize, fontFamily: font, textAnchor: "end", dy: "0.35em" }
    );
  }
  // Player 2 Flat Count
  if (flats[1] !== "") {
    ...
    svg.text(
      ...
      textY,
      parts[0],
      { fill: fill2, fontSize: fontSize, fontFamily: font, textAnchor: "start", dy: "0.35em" }
    );
    if (parts[1]) {
      const mainWidth = svg.measureText(parts[0] + " ").width;
      svg.text(
        ...
        textY,
        parts[1],
        { fill: fill2, fontSize: fontSize, fontFamily: font, textAnchor: "start", dy: "0.35em", opacity: 0.5 }
      );
    }
  }
...
exports.drawHeaderSvg = drawHeaderSvg;
