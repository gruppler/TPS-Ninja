...
import { TPStoSVG } from "../src/index.js";

const options = process.argv.slice(process.argv[0] === "TPStoSVG" ? 1 : 2);
if (!options.length) {
  console.log(
    "Usage: TPStoSVG <TPS|board size> [OPTION=VALUE ...]\n" +
      "TPS to SVG - Tak Positional System to Scalable Vector Graphics\n\n" +
      "Options:\n" +
      "  theme           [ID|JSON] Theme\n" +
      ...
      "  name            Filename of exported SVG, defaults to 'takboard.svg'\n" +
